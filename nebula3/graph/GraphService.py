...
from nebula3.fbthrift.Thrift import TType, TMessageType, TPriority, TRequestContext, TProcessorEventHandler, \
    TServerInterface, TProcessor, TException, TApplicationException, UnimplementedTypedef
...
from .ttypes import UTF8STRINGS, ProfilingStats, PlanNodeBranchInfo, Pair, PlanNodeDescription, PlanDescription, \
    ExecutionResponse, AuthResponse, VerifyClientVersionResp, VerifyClientVersionReq
...
class authenticate_args:
  ...
  """
    ...
    def read(self, iprot):
        if (isinstance(iprot, TBinaryProtocol.TBinaryProtocolAccelerated) or (isinstance(iprot,
                                                                                         THeaderProtocol.THeaderProtocolAccelerate) and iprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_BINARY_PROTOCOL)) and isinstance(
                iprot.trans, TTransport.CReadableTransport) and self.thrift_spec is not None and fastproto is not None:
            fastproto.decode(self, iprot.trans, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS,
                             protoid=0)
            return
        if (isinstance(iprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(iprot,
                                                                                           THeaderProtocol.THeaderProtocolAccelerate) and iprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and isinstance(
                iprot.trans, TTransport.CReadableTransport) and self.thrift_spec is not None and fastproto is not None:
            fastproto.decode(self, iprot.trans, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS,
                             protoid=2)
            return
    ...
    def write(self, oprot):
        if (isinstance(oprot, TBinaryProtocol.TBinaryProtocolAccelerated) or (isinstance(oprot,
                                                                                         THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_BINARY_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
            oprot.trans.write(
                fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=0))
            return
        if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot,
                                                                                           THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
            oprot.trans.write(
...
executeWithParameter_args.thrift_spec = (
    ...
    (1, TType.I64, 'sessionId', None, None, 2,),  # 1
    (2, TType.STRING, 'stmt', False, None, 2,),  # 2
    (3, TType.MAP, 'parameterMap',
     (TType.STRING, False, TType.STRUCT, [nebula3.common.ttypes.Value, nebula3.common.ttypes.Value.thrift_spec, True]),
     None, 2,),  # 3
)
...
class ContextProcessor(ContextIface, TProcessor):
    ...
    def process_executeWithParameter(self, args, handler_ctx):
        result = executeWithParameter_result()
        try:
            result.success = self._handler.executeWithParameter(handler_ctx, args.sessionId, args.stmt,
                                                                args.parameterMap)
        except:
            ex = sys.exc_info()[1]
            self._event_handler.handlerError(handler_ctx, 'executeWithParameter', ex)
    ...
    def process_executeJsonWithParameter(self, args, handler_ctx):
        result = executeJsonWithParameter_result()
        try:
            result.success = self._handler.executeJsonWithParameter(handler_ctx, args.sessionId, args.stmt,
                                                                    args.parameterMap)
        except:
            ex = sys.exc_info()[1]
            self._event_handler.handlerError(handler_ctx, 'executeJsonWithParameter', ex)
